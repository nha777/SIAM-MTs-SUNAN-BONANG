...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div><h1 class="text-2xl font-bold text-surface-900">Absensi Siswa</h1></div>
</div>
        ...
        <table class="min-w-full divide-y divide-gray-300">
            <thead class="bg-surface-50">
                <tr>
                    ...
                    <th class="px-3 py-3.5 text-left text-sm font-semibold text-surface-900">Tanggal</th>
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                ...
                <tr>
                    ...
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-surface-500">{{ $item->date->format('d M Y') }}</td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-surface-500">{{ $item->status }}</td>
                </tr>
                @empty
