...
use App\Modules\Academic\Repositories\AttendanceRepositoryInterface;

class AttendanceService implements AttendanceServiceInterface
{
    protected $repository;
    public function __construct(AttendanceRepositoryInterface $repository) { $this->repository = $repository; }
