<div x-data="{ show: false, actionUrl: '', title: '', message: '' }" 
     @open-activate-modal.window="show = true; actionUrl = $event.detail.actionUrl; title = $event.detail.title; message = $event.detail.message"
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            <h3 class="text-base font-semibold leading-6 text-surface-900" id="modal-title" x-text="title">Aktivasi</h3>
                            <div class="mt-2">
                                <p class="text-sm text-surface-500" x-text="message">Apakah Anda yakin ingin mengaktifkan data ini?</p>
                            </div>
                        </div>
                    </div>
                </div>
