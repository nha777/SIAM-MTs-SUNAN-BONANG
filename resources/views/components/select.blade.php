{{-- 
Component: Select
Description: A standardized select dropdown field.
Props:
...
@php
    $baseClasses = 'block w-full rounded-md shadow-sm sm:text-sm px-3 py-2 border bg-white focus:outline-none transition-colors duration-100';
