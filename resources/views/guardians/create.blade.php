...
<div class="flex items-center gap-4">
    ...
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-surface-900">Tambah Wali Murid</h1>
        <p class="mt-1 text-sm text-surface-500">Mendaftarkan data wali murid baru ke dalam sistem.</p>
    </div>
</div>
@endsection
