...
@section('title', 'Ubah Siswa - SIAM')
@section('header_title', 'Ubah Siswa')
...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h3 class="text-base font-semibold leading-6 text-surface-900">Ubah Data Siswa</h3>
            <p class="mt-2 text-sm text-surface-700">Perbarui informasi data siswa: {{ $student->name }} ({{ $student->nisn }}).</p>
        </div>
